<div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Buat Sebuah Janji</h1>
      ...
      <form class="main-form" action="{{url('appointment')}}" method="POST">
        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            ...
            <option>--Select Doctor--</option>
              ...
              <option value="{{$doctors->name}}">{{$doctors->name}} | {{$doctors->spesialist}}</option>
              @endforeach
            </select>
          </div>
        ...
        <button type="submit" class="btn btn-primary" style="background-color:#00D9A5">Submit</button>
      </form>
    </div>
  </div>